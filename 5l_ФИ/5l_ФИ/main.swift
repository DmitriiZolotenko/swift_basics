...
//  5l_ФИ
//
//  Created by Дмитрий Золотенко on 06.12.2021.
//
...
var sportCar1 = SportCar(brand: "Bugatti", color: "White", year: 1991, km: 200, engineState: .off, windowsState: .close, isSpoilerEnable: true, driveMode: .drift)
sportCar1.engineOn()
...
var sportCar2 = SportCar(brand: "McLaren",color: "Black", year: 2010, km: 100, engineState: .off, windowsState: .close, isSpoilerEnable: false, driveMode: .drag)
sportCar2.engineOn()
print(sportCar2.description)
sportCar2.drive()

var trunkCar1 = TrunkCar(brand: "MAN", color: "Gray", year: 2016, km: 499950, engineState: .on, windowsState: .open, capacity: 8000, truckType: .refrigirator)
trunkCar1.closeWindows()
print(trunkCar1.description)
trunkCar1.drive()

var trunkCar2 = TrunkCar(brand: "Kamaz", color: "Orange", year: 2001, km: 800010, engineState: .off, windowsState: .close, capacity: 6000, truckType: .tank)
